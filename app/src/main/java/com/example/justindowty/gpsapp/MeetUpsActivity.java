...
import static com.example.justindowty.gpsapp.MeetUpsFragment.meetUpAdapter;
import static com.example.justindowty.gpsapp.dummy.MeetUpContent.ITEMS;
    ...
    private void viewOnMap(MeetUpContent.MeetUpItem item) {
        dbRef.child("STATS").child(item.username).child("MEET_UP_CLICKS").addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                String timeAndDescription = item.time + " " + item.ampm + " - " + item.description;
